...
<form action="user_cadastro_cliente.php" method="post" id="cliente">
		<table>
		<tr><td><Label for="usuario">Nome</Label><td><input type="text" name="nome" id="nome" size="10" maxlength="10" required="">*
		<tr><td><label for="nome">Sobre nome:</label><td><input type="text" name="sobrenome" id="sobrenome" size="30" maxlength="30" placeholder="Digite seu nome" required="">*
