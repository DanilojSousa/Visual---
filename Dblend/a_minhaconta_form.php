...
<form action="a_minhaconta.php" method="post" id="cliente">
	<table>
		...
		<tr><td><label for="telefone">Telefone:</label><td><input type="tel" name="telefone" value="<?php echo $reg->telefone?>" id="telefone" size="11" maxlength="11" pattern="[0-9]{11}">
